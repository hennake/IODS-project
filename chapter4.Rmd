...
We can calculate from the confusion matrix that the total error rate is about 29 % in the test data. In other words, the model correctly classifies 71 % of new cases, which is not a bad rate compared to the expected success rate of 25 %, if randomly guessing one of four classes.
